  ...
  return (
    <div className='findYourForest'>
      <div className='findYourForest__bg'>
        <h1 className='findYourForest__bg__title'>Find the perfect way to clean your Forest</h1>
        <div className='findYourForest__bg__selector'>
          <div className='findYourForest__bg__selector__city'>
            <label className='findYourForest__bg__selector__city__title'>Filter par ville</label>
        ...
        {locations.length !== 0
          ? dataForest
              ...
              .map((forest, index) => <ForestCardList forest={forest} key={index} />)
          : dataForest.map((forest, index) => <ForestCardList forest={forest} key={index} />)}
      </div>
    </div>
  );
};
